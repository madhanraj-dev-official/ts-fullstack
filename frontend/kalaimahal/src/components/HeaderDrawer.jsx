...
export default function HeaderDrawer({isSubHeader}) {
        ...
        <List>
          ...
          {[
            ...
            <ListItem key={index} disablePadding>
              <ListItemButton sx={{color:"#fff",borderBottom:"1px solid"}} onClick={() => Navigation(route)}>
    ...
    <div>
      {/* {['right'].map((anchor) => ( */}
        <React.Fragment key={"right"}>
          <Button sx={{color : isSubHeader ? "black":"#fff"}} onClick={toggleDrawer("right", true)}><MenuIcon/></Button>
          <SwipeableDrawer
            anchor={"right"}
            open={state["right"]}
